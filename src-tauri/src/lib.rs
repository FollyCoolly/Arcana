...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::data_platform::load_pack_dashboard,
            commands::data_platform::set_pack_enabled,
            commands::data_platform::delete_pack,
            commands::data_platform::preview_pack_deletion,
