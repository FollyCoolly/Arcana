...
- Tauri Status、Achievement、Skill、Mission 页面已通过新 Application/SQLite 运行时；Items、Gallery 与内置 Rust Agent 暂时仍使用 `models/`、`services/` 和旧 JSON storage。只修复旧模型的必要问题，不在其中增加新数据平台功能。
